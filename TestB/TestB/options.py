...
def parse_args(script):
    ...
    parser.add_argument('--data_dir', default='/home/wx/Datas', type=str, help='')
    ...
    if script == 'train':
        ...
        parser.add_argument('--target_set', default='cub',
                            help='cub/cars/places/plantae, use the extremely labeled target data')
        ...
        parser.add_argument('--warmup', default='gg3bo', type=str,
                            help='just for insert the test function into the training.')
